        ...
        return (
            <Card style={styles.card} mode="outlined">
                <Card.Title
                    ...
                    left={() => <Avatar.Text size={40} labelStyle={styles.weekdayAvatar} label={item.weekday} />}
                />
                <Card.Content>
    ...
    return (
        <View style={sharedStyles.screen}>
            ...
            <Appbar.Header mode="small">
                ...
                <Appbar.Action icon="magnify" onPress={() => console.log("search schedule")} />
                <Appbar.Action icon="plus" onPress={() => console.log("add schedule")} />
            </Appbar.Header>
